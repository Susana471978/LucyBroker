...
const translations = {
  es: {
    ...
    // Overview
    welcomeTitle: "Tu día, organizado por Lucy",
    welcomeSubtitle: "Briefing, correos, agenda, tareas y hábitos. Todo en un solo lugar, gestionado por tu asistente con IA.",
  ...
  en: {
    ...
    // Overview
    welcomeTitle: "Your day, organized by Lucy",
    welcomeSubtitle: "Briefing, emails, calendar, tasks and habits. All in one place, managed by your AI assistant.",

...
const ActionCard = ({ icon, title, description, actionLabel, onAction, connected, connectedLabel, onDisconnect, delay = 0 }) => (
  <motion.div
    initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
    transition={{ delay, duration: 0.5, ease: [0.16, 1, 0.3, 1] }}
    className="group relative rounded-2xl p-5 bg-[rgba(255,255,255,0.025)] border border-[rgba(255,255,255,0.06)] backdrop-blur-sm overflow-hidden
    ...
    <div className="flex items-start gap-4">
      <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-300
        ${connected
          ...
          : 'bg-[rgba(201,178,124,0.08)] text-[rgba(201,178,124,0.6)] border border-[rgba(201,178,124,0.15)] group-hover:text-[#C9B27C]'
        }`}>
        {icon}
      </div>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          ...
          {connected && (
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs text-emerald-400/70">Conectado</span>
            </div>
          )}
        </div>
        ...
        {connected ? (
          ...
          <button onClick={onAction}
            className="flex items-center gap-1.5 text-xs text-[#C9B27C] hover:text-[#D4BC88] 
              border border-[rgba(201,178,124,0.2)] hover:border-[rgba(201,178,124,0.4)]
              px-3 py-1.5 rounded-lg transition-all duration-200 
              bg-[rgba(201,178,124,0.04)] hover:bg-[rgba(201,178,124,0.1)]"
          >
    ...
    <Layout>
      ...
      <div className="max-w-5xl mx-auto px-6 py-14 space-y-10">
        ...
        {!calendarLoading && calendarConnected && todayEvents.length > 0 && (
          ...
          >
            <button onClick={() => setCalendarExpanded(p => !p)}

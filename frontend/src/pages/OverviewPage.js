  ...
  <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
    ...
    <div className="flex items-start gap-4">
      <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-300
        ${connected ? 'bg-[rgba(52,211,153,0.08)] text-emerald-400 border border-[rgba(52,211,153,0.15)]' : 'bg-[rgba(201,178,124,0.08)] text-[rgba(201,178,124,0.6)] border border-[rgba(201,178,124,0.15)] group-hover:text-[#C9B27C]'}`}>{icon}</div>
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          <h4 className="text-sm font-medium text-[rgba(255,255,255,0.8)]">{title}</h4>
          {connected && (<div className="flex items-center gap-1.5"><div className="w-1.5 h-1.5 rounded-full bg-emerald-400 shadow-[0_0_6px_rgba(52,211,153,0.6)]" /><span className="text-xs text-emerald-400/70">Conectado</span></div>)}
        </div>
...
export default function OverviewPage() {
  ...
  const dismissBriefing = () => {
    ...
    setBriefingVisible(false); setBriefingIsSpeaking(false);
  };
    ...
    <Layout>
      ...
      <div className="max-w-5xl mx-auto px-6 py-14 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <ActionCard icon={<FileText className="w-4.5 h-4.5" />} title="Resumen de correos" description="Lucy analiza tu bandeja y te prepara un briefing ejecutivo." actionLabel="Generar briefing" onAction={() => runBriefing()} connected={gmailConnected && stats?.total > 0} connectedLabel={stats ? `${stats.total} emails · ${stats.prioritarios} prioritarios` : 'Listo'} delay={0.25} />
        </div>
            ...
            <div className="p-8 flex flex-col gap-7">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button onClick={() => runBriefing('repite mi briefing matutino')} className="w-8 h-8 rounded-xl flex items-center justify-center transition-all duration-200 bg-[rgba(201,178,124,0.06)] text-[rgba(201,178,124,0.45)] border border-[rgba(201,178,124,0.15)] hover:bg-[rgba(201,178,124,0.12)] hover:text-[#C9B27C]" title="Repetir briefing">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button onClick={handsFreeModeActive ? cancel : activateHandsFreeMode}
                  className={`rounded-xl p-5 text-left border transition-all duration-300 ${handsFreeModeActive ? 'bg-[rgba(52,211,153,0.06)] border-[rgba(52,211,153,0.2)]' : 'bg-[rgba(255,255,255,0.03)] border-[rgba(255,255,255,0.07)] hover:bg-[rgba(255,255,255,0.05)]'}`}>

...
const CATEGORIES = {
    ...
    proyecto: { label: 'Proyectos', icon: Briefcase, color: 'rgba(88,160,255,0.6)' },
    cliente: { label: 'Clientes', icon: Users, color: 'rgba(88,160,255,0.8)' },
    ...
    return (
        <motion.div
            ...
            style={{
                ...
                border: '1px solid rgba(88,160,255,0.10)',
            }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(88,160,255,0.18)'; e.currentTarget.style.background = 'rgba(7,12,24,0.6)'; }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(88,160,255,0.10)'; e.currentTarget.style.background = 'rgba(7,12,24,0.5)'; }}
        >
                ...
                {confirming ? (
                    <div className="flex items-center gap-1.5 flex-shrink-0">
                        ...
                        <button onClick={() => setConfirming(false)}
                            className="text-[10px] text-[var(--text-tertiary)] border border-[rgba(88,160,255,0.1)] px-2 py-1 rounded-lg hover:bg-[rgba(88,160,255,0.05)] transition-all duration-200">
                            No
                        </button>
                    </div>
                ) : (
                    <button onClick={() => setConfirming(true)}
                        className="flex-shrink-0 w-7 h-7 rounded-lg flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-200 text-[rgba(255,255,255,0.2)] hover:text-red-400 hover:bg-red-400/10">
    ...
    return (
        ...
        >
            <div className="rounded-2xl p-5 space-y-4"
                style={{ background: 'rgba(7,12,24,0.55)', border: '1px solid rgba(88,160,255,0.14)' }}>
                <textarea
                    value={text}
                    onChange={e => setText(e.target.value)}
                    placeholder="Ej: Mi cliente principal es Telefónica, prefiero reuniones por la mañana..."
                    className="w-full bg-transparent text-sm text-[var(--text-primary)] placeholder-[rgba(255,255,255,0.2)] rounded-xl px-4 py-3 resize-none transition-colors duration-200"
                    style={{ border: '1px solid rgba(88,160,255,0.12)' }}
                    onFocus={e => e.target.style.borderColor = 'rgba(201,178,124,0.3)'}
                    onBlur={e => e.target.style.borderColor = 'rgba(88,160,255,0.12)'}
                    rows={3}
                    autoFocus
                />
                ...
                <div className="flex items-center justify-between">
                    <div className="relative">
                        <button onClick={() => setCatOpen(o => !o)}
                            className="flex items-center gap-2 text-xs px-3 py-2 rounded-lg text-[rgba(255,255,255,0.4)] transition-all duration-200"
                            style={{ border: '1px solid rgba(88,160,255,0.12)' }}>
                        ...
                        {catOpen && (
                            <div className="absolute bottom-full mb-2 left-0 min-w-[160px] rounded-xl overflow-hidden z-10 shadow-[0_16px_48px_rgba(0,0,0,0.6)] backdrop-blur-xl"
                                style={{ background: 'rgba(7,12,24,0.95)', border: '1px solid rgba(88,160,255,0.14)' }}>
                        ...
                        ${category === key ? 'bg-[rgba(201,178,124,0.06)]' : 'hover:bg-[rgba(88,160,255,0.06)]'}`}>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={handleSubmit}
                            ...
                            className="text-xs text-[var(--champagne)] border border-[rgba(201,178,124,0.25)] px-4 py-2 rounded-lg bg-[rgba(201,178,124,0.06)] hover:bg-[var(--champagne-faint)] hover:border-[rgba(201,178,124,0.4)] disabled:opacity-30 disabled:cursor-not-allowed transition-all duration-200">
                            Guardar
                        </button>
                    </div>
                </div>
...
const ConnectionCard = ({ icon, title, connected, detail, onConnect, onDisconnect, delay = 0 }) => (
    <motion.div
        ...
        style={{ background: 'rgba(7,12,24,0.5)', border: '1px solid rgba(88,160,255,0.10)' }}
    >
        <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
                <div className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-300
          ${connected
                        ? 'bg-[rgba(88,160,255,0.08)] text-[rgba(88,160,255,0.9)] border border-[rgba(88,160,255,0.2)]'
                        : 'bg-[rgba(7,12,24,0.6)] text-[var(--text-tertiary)] border border-[rgba(88,160,255,0.12)]'
                    }`}>
                    {icon}
                </div>
                <div>
                    <div className="flex items-center gap-2">
                        ...
                        {connected && (
                            <>
                                <div className="w-1.5 h-1.5 rounded-full bg-[rgba(88,160,255,0.9)] shadow-[0_0_6px_rgba(88,160,255,0.6)]" />
                                <span className="text-[10px] text-[rgba(88,160,255,0.9)] uppercase tracking-[0.08em]">Conectado</span>
                            </>
                        )}
                    </div>
            ...
            {connected ? (
                <button onClick={onDisconnect}
                    className="text-xs text-[rgba(255,255,255,0.2)] hover:text-red-400 px-3 py-1.5 rounded-lg border border-[rgba(88,160,255,0.10)] hover:border-red-400/20 transition-all duration-200">
                    Desconectar
                </button>
            ) : (
                <button onClick={onConnect}
                    className="text-xs text-[var(--champagne)] border border-[var(--border-champagne)] px-3 py-1.5 rounded-lg bg-[rgba(201,178,124,0.04)] hover:bg-[rgba(201,178,124,0.1)] hover:border-[rgba(201,178,124,0.4)] transition-all duration-200">
                    Conectar
                </button>
            )}
        </div>
    ...
    return (
        ...
        >
            <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
                ...
                <Building2 className="w-3.5 h-3.5 text-[var(--champagne)]" />
            </div>
            <div className="flex-1 min-w-0">
                <p className="text-sm text-[var(--text-primary)] truncate">{company.name}</p>
        ...
        >
            <div className="rounded-2xl p-5 space-y-4"
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div>
                        <label className="text-[10px] text-[var(--text-tertiary)] uppercase tracking-[0.1em] mb-1.5 block">
                        ...
                        <input
                            ...
                            className="w-full bg-transparent text-sm text-[var(--text-primary)] placeholder-[rgba(255,255,255,0.2)] rounded-xl px-4 py-2.5 transition-colors duration-200 outline-none"
        ...
        <Layout>
            <div className="max-w-3xl mx-auto px-6 py-14 space-y-12">
                ...
                <button onClick={() => window.history.back()}
                    className="flex items-center gap-1.5 text-xs text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] -mb-8 transition-colors duration-200">
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                    <p className="text-xs text-[rgba(201,178,124,0.5)] uppercase tracking-[0.1em] font-medium mb-3">Configuración</p>
                    <h1 className="font-light tracking-tight text-[var(--text-primary)] mb-2"
                        ...
                        Memoria de <span style={{ color: 'var(--champagne)' }}>Lucy</span>
                    </h1>
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.5 }}>
                    <h2 className="text-xs text-[rgba(201,178,124,0.45)] uppercase tracking-[0.1em] font-medium mb-4">Conexiones</h2>
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15, duration: 0.5 }}>
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p className="text-[11px] text-[rgba(255,255,255,0.2)] mt-1">
                        ...
                        {!vipLocked && !showAddVip && !vipLoading && (
                            <button onClick={() => { setShowAddVip(true); setVipError(''); }}
                                className="flex items-center gap-1.5 text-xs text-[var(--champagne)] border border-[var(--border-champagne)] px-3 py-1.5 rounded-lg bg-[rgba(201,178,124,0.04)] hover:bg-[rgba(201,178,124,0.1)] hover:border-[rgba(201,178,124,0.4)] transition-all duration-200">
                    ...
                    {vipLocked ? (
                        <div className="text-center py-10 rounded-xl relative overflow-hidden"
                            ...
                            <p className="text-sm text-[var(--text-tertiary)]">
                                Disponible desde <span className="text-[var(--champagne)]">{vipMinPlan}</span>
                            </p>
                            <p className="text-xs text-[rgba(255,255,255,0.15)] mt-1 mb-4">
                                Mejora tu plan para que Lucy priorice los correos de tus empresas clave
                            </p>
                            <button
                                onClick={() => window.location.href = '/app/pricing'}
                                className="text-xs text-[var(--champagne)] border border-[rgba(201,178,124,0.25)] px-5 py-2 rounded-xl bg-[rgba(201,178,124,0.06)] hover:bg-[var(--champagne-faint)] hover:border-[rgba(201,178,124,0.4)] transition-all duration-200"
                            >
                                Ver planes
                            </button>
                        </div>
                        ...
                        <>
                            ...
                            {vipLoading ? (
                                <div className="flex items-center justify-center py-8">
                                    <div className="w-5 h-5 border-2 border-[rgba(201,178,124,0.3)] border-t-[var(--champagne)] rounded-full animate-spin" />
                                </div>
                                ...
                                <div className="text-center py-8 rounded-xl"
                                    ...
                                    <p className="text-xs text-[rgba(255,255,255,0.12)] mt-1">
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.5 }}>
                    <h2 className="text-xs text-[rgba(201,178,124,0.45)] uppercase tracking-[0.1em] font-medium mb-4">Voz</h2>
                    <div className="rounded-xl p-4" style={{ background: 'rgba(7,12,24,0.5)', border: '1px solid rgba(88,160,255,0.10)' }}>
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                {ttsEnabled ? <Volume2 className="w-4 h-4 text-[var(--champagne)]" /> : <VolumeX className="w-4 h-4 text-[var(--text-tertiary)]" />}
                                <div>
                                    <p className="text-sm text-[var(--text-primary)]">Voz de Lucy</p>
                                    <p className="text-xs text-[var(--text-tertiary)] mt-0.5">{ttsEnabled ? 'Lucy habla en voz alta' : 'Lucy solo responde con texto'}</p>
                                </div>
                            </div>
                            <button onClick={() => setTtsEnabled(prev => !prev)}
                                className={`relative w-12 h-7 rounded-full transition-all duration-300 ${ttsEnabled ? 'bg-[rgba(201,178,124,0.15)] border border-[rgba(201,178,124,0.35)]' : 'bg-[rgba(7,12,24,0.6)] border border-[rgba(88,160,255,0.12)]'}`}>
                                <div className={`absolute top-1 w-5 h-5 rounded-full transition-all duration-300 ${ttsEnabled ? 'left-6 bg-[var(--champagne)]' : 'left-1 bg-[rgba(255,255,255,0.3)]'}`} />
                            </button>
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25, duration: 0.5 }}>
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xs text-[rgba(201,178,124,0.45)] uppercase tracking-[0.1em] font-medium">Notas ({notes.length})</h2>
                        {!showAddForm && (
                    ...
                    {notes.length > 0 && (
                        <div className="flex items-center gap-2 mb-4 flex-wrap">
                            <button onClick={() => setFilter('all')}
                                className={`text-[10px] uppercase tracking-[0.08em] px-3 py-1.5 rounded-lg border transition-all duration-200 ${filter === 'all' ? 'text-[var(--champagne)] border-[rgba(201,178,124,0.25)] bg-[rgba(201,178,124,0.06)]' : 'text-[var(--text-tertiary)] border-[rgba(88,160,255,0.10)] hover:border-[rgba(88,160,255,0.18)]'}`}>
                                Todas ({notes.length})
                            </button>
                            {Object.entries(CATEGORIES).map(([key, val]) => {
                                ...
                                return (
                                    <button key={key} onClick={() => setFilter(key)}
                                        className={`text-[10px] uppercase tracking-[0.08em] px-3 py-1.5 rounded-lg border transition-all duration-200 ${filter === key ? 'border-[rgba(201,178,124,0.25)] bg-[rgba(201,178,124,0.06)]' : 'border-[rgba(88,160,255,0.10)] hover:border-[rgba(88,160,255,0.18)]'}`}
                    ...
                    {notesLoading ? (
                        ...
                        <div className="text-center py-12">
                            <Brain className="w-10 h-10 mx-auto text-[rgba(201,178,124,0.15)] mb-4" />
                            <p className="text-sm text-[var(--text-tertiary)]">
                    ...
                    {notes.length < 5 && (
                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5, duration: 0.6 }}
                            ...
                            style={{ background: 'rgba(201,178,124,0.03)', border: '1px solid rgba(201,178,124,0.1)' }}>

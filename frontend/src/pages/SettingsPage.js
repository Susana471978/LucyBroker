            ...
            <div className="flex items-start gap-3">
                ...
                hover:bg-red-400/10 transition-all duration-200">
                        ...
                        <button onClick={() => setConfirming(false)}
                            className="text-[10px] text-[rgba(224,247,250,0.3)] border border-[rgba(0,180,216,0.1)] px-2 py-1 rounded-lg
                hover:bg-[rgba(0,180,216,0.05)] transition-all duration-200">
                            No
                        </button>
                    </div>
                ) : (
              ...
              text-[rgba(224,247,250,0.2)] hover:text-red-400 hover:bg-red-400/10">
        ...
        >
            <div className="rounded-2xl p-5 space-y-4"
                ...
                <textarea
                    ...
                    className="w-full bg-transparent text-sm text-[rgba(224,247,250,0.7)] placeholder-[rgba(224,247,250,0.2)]
            rounded-xl px-4 py-3 resize-none transition-colors duration-200"
                    style={{
                ...
                text-[rgba(224,247,250,0.4)] transition-all duration-200"
...
/* ─────────────────────────────────────────────────────────
   CONNECTION CARD — azul neón en vez de verde
───────────────────────────────────────────────────────── */
          ...
          ${connected
            ...
            {connected ? (
                <button onClick={onDisconnect}
                    className="text-xs text-[rgba(224,247,250,0.2)] hover:text-red-400 px-3 py-1.5 rounded-lg
            border border-[rgba(0,180,216,0.08)] hover:border-red-400/20 transition-all duration-200">
                    Desconectar
                </button>
            ) : (
        ...
        <Layout>
            <div className="max-w-3xl mx-auto px-6 py-14 space-y-12">
                ...
                <button onClick={() => window.history.back()}
                    className="flex items-center gap-1.5 text-xs text-[rgba(224,247,250,0.25)] hover:text-[rgba(224,247,250,0.5)]
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.5 }}>
                    <h2 className="text-xs text-[rgba(0,180,216,0.35)] uppercase tracking-[0.1em] font-medium mb-4">
                        Conexiones
                    </h2>
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.5 }}>
                  ...
                  ${ttsEnabled
                                        ? 'bg-[rgba(0,180,216,0.2)] border border-[rgba(0,180,216,0.4)]'
                                        : 'bg-[rgba(4,18,32,0.6)] border border-[rgba(0,180,216,0.12)]'
                                    }`}>
                                <div className={`absolute top-1 w-5 h-5 rounded-full transition-all duration-300
                  ${ttsEnabled
                                        ? 'left-6 bg-[#00B4D8]'
                                        : 'left-1 bg-[rgba(224,247,250,0.3)]'
                                    }`} />
                            </button>
                        </div>
                    </div>
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25, duration: 0.5 }}>
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xs text-[rgba(0,180,216,0.35)] uppercase tracking-[0.1em] font-medium">
                            Notas ({notes.length})
                        </h2>
                        {!showAddForm && (
                  ...
                  ${filter === 'all'
                                        ...
                                        : 'text-[rgba(224,247,250,0.3)] border-[rgba(0,180,216,0.08)] hover:border-[rgba(0,180,216,0.15)]'
                                    }`}>
                                Todas ({notes.length})
                            </button>
                            {Object.entries(CATEGORIES).map(([key, val]) => {
                      ...
                      ${filter === key
                                                ...
                                                : 'border-[rgba(0,180,216,0.08)] hover:border-[rgba(0,180,216,0.15)]'
                                            }`}

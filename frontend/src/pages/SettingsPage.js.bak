                ...
                {confirming ? (
                    <div className="flex items-center gap-1.5 flex-shrink-0">
                        ...
                        <button onClick={() => setConfirming(false)}
                            className="text-[10px] text-[rgba(255,255,255,0.3)] border border-[rgba(88,160,255,0.1)] px-2 py-1 rounded-lg hover:bg-[rgba(88,160,255,0.05)] transition-all duration-200">
                            No
                        </button>
                    </div>
                ) : (
        ...
        >
            <div className="rounded-2xl p-5 space-y-4"
                ...
                <textarea
                    ...
                    className="w-full bg-transparent text-sm text-[rgba(255,255,255,0.7)] placeholder-[rgba(255,255,255,0.2)] rounded-xl px-4 py-3 resize-none transition-colors duration-200"
    ...
    >
        <div className="flex items-center justify-between">
          ...
          ${connected
                        ...
                        : 'bg-[rgba(7,12,24,0.6)] text-[rgba(255,255,255,0.3)] border border-[rgba(88,160,255,0.12)]'
                    }`}>
                    {icon}
                </div>
                <div>
...
const VipCompanyCard = ({ company, onDelete, delay = 0 }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <p className="text-sm text-[rgba(255,255,255,0.75)] truncate">{company.name}</p>
        ...
        >
            <div className="rounded-2xl p-5 space-y-4"
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div>
                        <label className="text-[10px] text-[rgba(255,255,255,0.3)] uppercase tracking-[0.1em] mb-1.5 block">
                        ...
                        <input
                            ...
                            className="w-full bg-transparent text-sm text-[rgba(255,255,255,0.7)] placeholder-[rgba(255,255,255,0.2)] rounded-xl px-4 py-2.5 transition-colors duration-200 outline-none"
        ...
        <Layout>
            <div className="max-w-3xl mx-auto px-6 py-14 space-y-12">
                ...
                <button onClick={() => window.history.back()}
                    className="flex items-center gap-1.5 text-xs text-[rgba(255,255,255,0.25)] hover:text-[rgba(255,255,255,0.5)] -mb-8 transition-colors duration-200">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-[rgba(255,255,255,0.25)] mt-0.5">{ttsEnabled ? 'Lucy habla en voz alta' : 'Lucy solo responde con texto'}</p>
                                </div>
                            </div>
                            <button onClick={() => setTtsEnabled(prev => !prev)}
                                ...
                                <div className={`absolute top-1 w-5 h-5 rounded-full transition-all duration-300 ${ttsEnabled ? 'left-6 bg-[#C9B27C]' : 'left-1 bg-[rgba(255,255,255,0.3)]'}`} />
                            </button>
                        </div>
                    </div>
                </motion.div>
                    ...
                    {notes.length > 0 && (
                        <div className="flex items-center gap-2 mb-4 flex-wrap">
                            <button onClick={() => setFilter('all')}
                                className={`text-[10px] uppercase tracking-[0.08em] px-3 py-1.5 rounded-lg border transition-all duration-200 ${filter === 'all' ? 'text-[#C9B27C] border-[rgba(201,178,124,0.25)] bg-[rgba(201,178,124,0.06)]' : 'text-[rgba(255,255,255,0.3)] border-[rgba(88,160,255,0.10)] hover:border-[rgba(88,160,255,0.18)]'}`}>
                                Todas ({notes.length})
                            </button>
                            {Object.entries(CATEGORIES).map(([key, val]) => {

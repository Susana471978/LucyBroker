  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: "28px 24px 24px", borderBottom: "1px solid rgba(201,168,112,0.06)" }}>
        <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.85rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#C9A870" }}>Lucy</div>
        <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.72rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(242,239,233,0.55)", marginTop: 3 }}>Broker</div>
      </div>
        ...
        {visible.map(item => {
          ...
          return (
            <button key={item.key} onClick={() => navigate(item.path)} style={{
              ...
              fontSize: "0.85rem", fontFamily: "'Instrument Sans', sans-serif",
      ...
      <div style={{ padding: "16px 24px", borderTop: "1px solid rgba(201,168,112,0.06)" }}>
        <div style={{ fontSize: "0.8rem", color: "rgba(242,239,233,0.75)", fontWeight: 500, marginBottom: 2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{user?.name}</div>
        <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.72rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(201,168,112,0.7)", marginBottom: 12 }}>{role}</div>
        <button onClick={logout} style={{ background: "none", border: "none", fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.72rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(242,239,233,0.45)", cursor: "pointer", padding: 0, transition: "color 0.18s" }}

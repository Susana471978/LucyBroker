...
export default function LucyConversationCard({
    ...
    return (
        ...
        >
            ...
            {/* ── Mode pill toggle: always visible ── */}
            ...
            <AnimatePresence mode="wait">
                ...
                {!handsFreeModeActive && (
                    ...
                    >
                        ...
                        >
                            <div
                                className="lucy-input-wrap flex items-center gap-3 px-4"
                            >
                                <input
                                    name="lucyInput"
                                    type="text"
                                    placeholder={sending ? 'Lucy está pensando…' : 'Dime qué necesitas…'}
                                    disabled={sending}
                                ...
                                >
                                    {sending
                                        ? <div className="w-3 h-3 rounded-full animate-spin" style={{ border: '1px solid rgba(201,178,124,0.3)', borderTopColor: 'var(--champagne)' }} />
                                        : <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="rgba(201,178,124,0.6)" strokeWidth="1.8"><line x1="22" y1="2" x2="11" y2="13" /><polygon points="22 2 15 22 11 13 2 9 22 2" /></svg>
                                    }
                                </button>
                            </div>
                        </form>
